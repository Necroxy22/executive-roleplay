...
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, 1444.6307,-23.8579,-55.6020)) return ErrorMsg(playerid, "Anda harus berada di kantor pemerintah!");
...
CMD:mybis(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_MY_BISNIS, DIALOG_STYLE_LIST, "Executive - Bisnis Saya", CMDSString, "Pilih", "Batal");
	return 1;
}
...
CMD:bm(playerid, params[])
{
    ...
    ShowPlayerDialog(playerid, BISNIS_MENU, DIALOG_STYLE_LIST, "Executive - Bisnis Menu","Bisnis Info\nGanti Nama\nPendapatan Bisnis\nHarga Product\nRequest Restock","Pilih","Tutup");
    return 1;
}
